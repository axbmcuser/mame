...
ROM_START( umk3p )
	...
	/* sockets U114 through U117 added for umk3p */
...
GAME( 1994, umk3p,     umk3,     wunit_picemu, mk3,      midwunit_state, init_umk3,     ROT0, "Midway", "Ultimate Mortal Kombat 3 Plus (Beta)", MACHINE_SUPPORTS_SAVE )
